...
/// Custom enums are the preferred way to define ui ids. It's clearer and
/// more extensible than any other types (such as &'str).
...
pub enum AppId {
    ...
    NameInput,
    HelloButton,
    Label(u8), // Ids for static controls that won't be referenced in the
    // Ui logic can be shortened this way.
